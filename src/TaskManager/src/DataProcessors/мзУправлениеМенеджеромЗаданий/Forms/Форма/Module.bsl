...
Процедура Настройки(Команда)
	...
	ОткрытьФорму("РегистрСведений.мзНастройкиМетодовОбработчиков.ФормаСписка");
...
&НаКлиенте
Процедура ОткрытьФормуСостоянияВыполненияЗаданий(Команда)
	ОткрытьФорму("Обработка.мзУправлениеМенеджеромЗаданий.Форма.СостояниеВыполненияЗаданий",,, УникальныйИдентификатор);
КонецПроцедуры